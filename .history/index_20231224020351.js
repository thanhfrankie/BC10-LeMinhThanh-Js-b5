...
function tinhTienCap() {
  var khachHang = document.getElementById("khach-hang").value 
  var maKhachHang = document.getElementById("ma-khach-hang").value*1
  var soKetNoi = document.getElementById("so-ket-noi").value *1
  var hoaDonTienCap = document.getElementById("hoa-don-tien-cap") *1
  ...
  if (khachHang === "Nhà Dân") {
    tongTienPhaiTra = phiXuLyHoaDonNhaDan + phiDichVuCoBanNhaDan * maKhachHang + thueKenhCaoCapNhaDan * soKetNoi
    hoaDonTienCap.innerHTML = ` Khách hàng: ${khachHang}, tiền cáp: ${tongTienPhaiTra}  `
  } else {
    switch (soKetNoi) {
      case soKetNoi <= 10: phiDichVuCoBanDoanhNghiep = 75;
        case soKetNoi >10: phiDichVuCoBanDoanhNghiep = 75 + (soKetNoi -10) *5
  }
  tongTienPhaiTra = phiXuLyHoaDonDoanhNghiep + phiDichVuCoBanDoanhNghiep + thueKenhCaoCapDoanhNghiep
  }
  hoaDonTienCap.innerHTML = ` Khách hàng: ${khachHang}, tiền cáp: ${tongTienPhaiTra}  `
}