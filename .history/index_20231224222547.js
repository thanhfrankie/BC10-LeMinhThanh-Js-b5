...
function tinhTienThue() {
  ...
  if (thuNhapNam > 0 &&thuNhapNam <= 60e+6) {
    tienThuNhapCaNhan = (thuNhapNam* 0.05 - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
  ...
  if (thuNhapNam > 60e+6 && thuNhapNam <=120e+6) {
    tienThuNhapCaNhan = ((60e+6*0.05 +(thuNhapNam-60)*0.1) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
  if (thuNhapNam > 120e+6 && thuNhapNam <=210e+6) {
    tienThuNhapCaNhan = ((60e+6*0.05+60e+6 * 0.1 +(thuNhapNam-120)*0.15) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
  if (thuNhapNam > 210e+6 && thuNhapNam <=384e+6) {
    tienThuNhapCaNhan = ((60e+6*0.05+60e+6 * 0.1 + 90e+6 * 0.15 +(thuNhapNam-210)*0.2) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
  if (thuNhapNam > 384e+6 && thuNhapNam <=624e+6) {
    tienThuNhapCaNhan = ((60e+6*0.05+60e+6 * 0.1 + 90e+6 * 0.15 +174 * 0.2 +(thuNhapNam-384)*0.25) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
  if (thuNhapNam > 624e+6 && thuNhapNam <=960e+6) {
    tienThuNhapCaNhan = ((60e+6*0.05+60e+6 * 0.1 + 90e+6 * 0.15 +174 * 0.2 + 240 * 0.25 +(thuNhapNam-624)*0.3) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
  if (thuNhapNam > 960e+6 ) {
    tienThuNhapCaNhan = ((60e+6*0.05+60e+6 * 0.1 + 90e+6 * 0.15 +174 * 0.2 + 240 * 0.25 +336 *0.3  +(thuNhapNam-960)*0.35) - 4e+5 - soNguoiPhuThuoc * 1.6e+6)/12
    return thuNhapChiuThue.innerHTML= `Họ tên: ${hoTen}, Tiền thuế thu nhập cá nhân: ${tienThuNhapCaNhan} VND `
  }
}
