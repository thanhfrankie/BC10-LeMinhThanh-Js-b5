...
function tinhTienThue() {
  ...
  var nguoiPhuThuoc = document.getElementById("so-nguoi-phu-thuoc").value * 1
  var tinhTienThue = document.getElementById("tinh-tien-thue")
  var so = 4e+5
  var tienThuNhapCaNhan = 0
  if (thuNhapNam < 60) {
    tienThuNhapCaNhan = thuNhapNam - 4e+6
  }
}
