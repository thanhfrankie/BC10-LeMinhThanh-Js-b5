...
function tuyenSinh() {
  ...
  var diemMon1 = document.getElementById("diem-mon-thu-1").value ;
  var diemMon2 = document.getElementById("diem-mon-thu-2").value ;
  var diemMon3 = document.getElementById("diem-mon-thu-3").value ;
  ...
  var ketQua = document.getElementById("ket-qua-t");
